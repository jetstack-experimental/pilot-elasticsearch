...
is ready. It is also responsible for removing nodes from the cluster
upon a scale down event.`,
...
func initConfig() {
	...
	viper.SetConfigName(".pilot") // name of config file (without extension)
